...
\section{Tests of the default Kernel Search}
The following table outlines the result of the Kernel Search
algorithm with the default configuration.
The tables includes the best solution found, the time elapsed in order to find it (with a maximum time limit of two minutes) and if the time limit was reached.
